...
export default function Player({
  ...
  async function playAudio() {
    ...
    try {
      ...
      /*
       * Usamos console.warn em vez de
       * console.error para o Next.js não
       * abrir o overlay vermelho durante
       * o desenvolvimento.
       */
      console.warn(
  ...
  function handleAudioError() {
    ...
    /*
     * IMPORTANTE:
     * Não usar console.error aqui.
     * No modo dev do Next.js isso pode
     * abrir o overlay vermelho na tela.
     */
    console.warn(
